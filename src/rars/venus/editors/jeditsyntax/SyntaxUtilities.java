...
public class SyntaxUtilities {
    ...
    public static SyntaxStyle[] getDefaultSyntaxStyles() {
        ...
        styles[Token.NULL] = new SyntaxStyle(getThemeColorOrDefault("SyntaxText", getThemeColorOrDefault("Black", Color.BLACK)), false, false);
        styles[Token.COMMENT1] = new SyntaxStyle(getThemeColorOrDefault("SyntaxComment", new Color(0x00CC33)), true, false);//(Color.black,true,false);
        styles[Token.COMMENT2] = new SyntaxStyle(getThemeColorOrDefault("SyntaxComment2", new Color(0x990033)), true, false);
        styles[Token.KEYWORD1] = new SyntaxStyle(getThemeColorOrDefault("SyntaxInstruction", Color.blue), false, false);//(Color.black,false,true);
        styles[Token.KEYWORD2] = new SyntaxStyle(getThemeColorOrDefault("SyntaxAssemblerDirective", Color.magenta), false, false);
        styles[Token.KEYWORD3] = new SyntaxStyle(getThemeColorOrDefault("SyntaxRegister", Color.red), false, false);//(new Color(0x009600),false,false);
        styles[Token.LITERAL1] = new SyntaxStyle(getThemeColorOrDefault("SyntaxStringLiteral", new Color(0x00CC33)), false, false);//(new Color(0x650099),false,false);
        styles[Token.LITERAL2] = new SyntaxStyle(getThemeColorOrDefault("SyntaxCharacterLiteral", new Color(0x00CC33)), false, false);//(new Color(0x650099),false,true);
        styles[Token.LABEL] = new SyntaxStyle(getThemeColorOrDefault("SyntaxLabel", getThemeColorOrDefault("Black", Color.BLACK)), true, false);//(new Color(0x990033),false,true);
        styles[Token.OPERATOR] = new SyntaxStyle(getThemeColorOrDefault("SyntaxOperator", getThemeColorOrDefault("Black", Color.BLACK)), false, true);
        styles[Token.INVALID] = new SyntaxStyle(getThemeColorOrDefault("SyntaxInvalid", Color.red), false, false);
        styles[Token.MACRO_ARG] = new SyntaxStyle(getThemeColorOrDefault("SyntaxMacroParameter", new Color(150, 150, 0)), false, false);
        return styles;
    }
